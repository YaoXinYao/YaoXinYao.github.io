  ...
  (function ($) {
    $.fn.nekoScroll = function (option) {
      ...
      $(getThis).css({
        ...
        "background-image":
          "-webkit-linear-gradient(45deg, rgba(255, 255, 255, 0.5) 25%, transparent 25%, transparent 50%, rgba(255, 255, 255, 0.5) 50%, rgba(255, 255, 255, 0.5) 75%, transparent 75%, transparent)",
        "border-radius": "2em",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| 你好可爱")
...
if ((y == 2024 && m == 4 && dd == 4) || (y == 2025 && m == 4 && dd == 4)) {
  //清明节
  if (sessionStorage.getItem("isPopupWindow") != "1") {
...
<details class="folding-tag" cyan><summary> 查看原神背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/Arknights/原神1.webp)" class="imgbox" onclick="changeBg('url(/assets/images/Arknights/原神1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/Arknights/原神2.webp)" class="imgbox" onclick="changeBg('url(/assets/images/Arknights/原神2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/Arknights/原神3.webp)" class="imgbox" onclick="changeBg('url(/assets/images/Arknights/原神3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/Arknights/原神4.jpg)" class="imgbox" onclick="changeBg('url(/assets/images/Arknights/原神4.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/Arknights/原神5.png)" class="imgbox" onclick="changeBg('url(/assets/images/Arknights/原神5.png)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/cartoon/1.webp)" class="imgbox" onclick="changeBg('url(/assets/images/cartoon/1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/cartoon/2.webp)" class="imgbox" onclick="changeBg('url(/assets/images/cartoon/2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/cartoon/3.webp)" class="imgbox" onclick="changeBg('url(/assets/images/cartoon/3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/cartoon/4.jpg)" class="imgbox" onclick="changeBg('url(/assets/images/cartoon/4.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/cartoon/5.webp)" class="imgbox" onclick="changeBg('url(/assets/images/cartoon/5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/cartoon/6.webp)" class="imgbox" onclick="changeBg('url(/assets/images/cartoon/6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/cartoon/7.webp)" class="imgbox" onclick="changeBg('url(/assets/images/cartoon/7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/cartoon/8.jpg)" class="imgbox" onclick="changeBg('url(/assets/images/cartoon/8.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/cartoon/9.webp)" class="imgbox" onclick="changeBg('url(/assets/images/cartoon/9.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 设置自定义背景 </summary>
              <div class='content'>
              <p>  <center>    <input type="text" id="pic-link" size="70%" maxlength="1000" placeholder="请输入有效的图片链接，如 https://cdn.staticaly.com/gh/1405720461/images@master/rem/18.webp">  </center></p><p>  <center>    <button type="button" class="custom_bg" onclick="getPicture()" style="background:var(--theme-color);width:35%;padding: 5px 0px 7px 0px;border-radius:30px;color:white;line-height:2;">🌈切换背景🌈</button>  </center></p>
              </div>
            </details>
